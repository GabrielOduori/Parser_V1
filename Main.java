/*
 * 
 * This script is the starting point of the program. Click run to begin.
 * 
 * 
 */
...
//		System.out.println(parser.isInLanguage(cfg, testString));
	...
	public static void main(String[] args) {
		if (!SKIP_TO_TESTS) {
			...
			do {
				...
				System.out.println("4 - Run Brute Force Algorithm");
	...
	public static void runBruteForce() {
		...
		boolean isInLanguage = parser.isInLanguage(cfg, new Word(inputString));
		if (isInLanguage == true) {
			System.out.println("The word '" + inputString + "' is part of the context free grammar\n");
			ParseTreeNode parseTreeNode = parser.generateParseTree(cfg, new Word(inputString));
			parseTreeNode.print();
		} else {
			System.out.println("The word '" + inputString + "' is not part of the context free grammar\n");
		}
